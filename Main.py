...
if NR == 'Y':
    ...
    Modulos_NR, Angulos_NR, p_i_NR, q_i_NR, Iteracion_NR, Error_NR, Fasor = Newton_Rapson.newtonRaphson(Convergencia, Max_iter,Y_Bus,P_gen,P_demanda,Q_gen,Q_demanda,V_pu,Bus_type, Z_zip, I_zip, P_zip)
